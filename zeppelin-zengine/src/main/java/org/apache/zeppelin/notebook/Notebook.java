...
public class Notebook implements NoteEventListener {
  ...
  public static class CronJob implements org.quartz.Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
      ...
      //TODO:这里会报错，原因是notebook被持久化到了，deserialize之后，notebook的notes已经与系统运行时的notes不匹配了
  ...
  public void refreshCron(String id) {
    ...
    synchronized (notes) {
      ...
      JobDetail newJob = JobBuilder.newJob(CronJob.class).withIdentity(id, "note").usingJobData("noteId", id)
              .build();
  ...
  public NotebookAuthorizationAdaptor getNotebookAuthorization() {
